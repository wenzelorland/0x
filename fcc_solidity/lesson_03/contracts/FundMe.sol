...
// this is the same as posting this code below:
...
// interfaces are essentially a minimalistic view into a contract.
...
contract FundMe {
    ...
    // automatically accounting for overflow in integer
    // using keywords for:
    ...
    // attaching the SafeMathChainlink library to the FundMe contract; is not needed for solidity >= 0.8.0
